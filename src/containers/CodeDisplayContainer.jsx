...
const CodeDisplayContainer = (props) => {
	...
	function renderCode(items, stateSelection = selectedState) {
		let code = '';
		...
		return componentRender(code, stateSelection, DLFileName);
	}
	...
	return (
		<div className="codeDisplay">
			...
			<div className="downloadButton">
				...
				<input type="text" value={DLFileName} placeholder="e.g. Button, Div" onChange={onChangeDL} />
